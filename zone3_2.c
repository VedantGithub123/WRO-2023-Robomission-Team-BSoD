void zone3(){ // This zone pick up the remaining cargo and drops it in the small ship
	...
	clearTimer(T4);
	while (getMotorEncoder(right)<900){ // Stops at 850 degrees
	...
	movePID(40,-0.5,0,0,0.25,286,40,-0.5,0,0,0.25,286);
	...
	movePID(50,-0.5,0,0,0.09,-460,50,-0.5,0,0,0.09,460);

	movePID(40,-0.4,0,0,0.09,-557,15,-0.5,0,0,0.5,0);
	...
	waitUntil(getMotorEncoder(right)>5);
